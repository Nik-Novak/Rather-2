...
\midrule
\multirow{7}{0.3\textwidth}{Behaviour-Hiding Module} & ?\\ % why the question mark?
& Twitter-API.js\\
& Facebook-API.js\\
&Filter-Feature.js\\
&Detect-Website.js\\
...
\multirow{3}{0.3\textwidth}{Non Java-script Modules and Design modules} & {?}\\ % why the question mark?
& manifest.json\\
& popup.html \\
\bottomrule
\end{tabular}
...
\end{description}
\subsubsection{Input Format Module (\mref{mInput})} %% this doesn't get rendered correctly
\begin{description}
...
R2 &  popup.html\\
R3 &  popup.html\\
R4 &  Facebook-API.js, Twttier-API.js, Detect-Website.js\\ % "Twttier" ?
